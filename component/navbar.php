    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="auth">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link me-4" aria-current="page" href="user/login.php">Login</a>
            </li>
            <li class="nav-item ">
              <a class="btn rounded-pill text-white" style="background-color: #4FA3C6;" id="signup" aria-current="page" href="user/register.php">Sign up</a>
            </li>
          </ul>
        </div>
