...
$query = mysqli_query($conn, "SELECT * FROM teknisi ORDER BY kode_teknisi ASC");
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Teknisi</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Teknisi</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                ...
                <div class="mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Data Seluruh Teknisi Semudah</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['created_at'] ?></td>
                                                    <td>
                                                        <a href="action/edit-teknisi/edit.php?id=<?= $d['kode_teknisi'] ?>"><i class="ti-pencil"></i></a>
                                                        <a href="action/edit-teknisi/delete.php?id=<?= $d['kode_teknisi'] ?>" onclick="return confirm('Yakin ingin menghapus?')"><i class="ti-trash"></i> </a>
                                                    </td>
                                                </tr>
                                            <?php
                                            endforeach;
