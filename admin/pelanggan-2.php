...
$query = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 2");
...
<head>
    ...
    <title>Pelanggan - Sedang Dijemput</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="pelanggan-2.php">Sedang Dijemput <span class="badge badge-light"><?= $row2 ?></span></a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Pelanggan yang sedang dijemput</h4>
