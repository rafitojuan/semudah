...
$query = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan");
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="pelanggan-all.php">Semua Pelanggan <span class="badge badge-light"><?= $rowAll ?></span></a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Data Seluruh Pelanggan</h4>
