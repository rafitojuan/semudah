                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['email'] ?></td>
                                                    <td><?= $d['telp'] ?></td>
                                                    <td>  <a href="..//user/asset /img_user/<?= $d['gambar']?>"><img src="../user/asset/img_user/<?= $d['gambar']?>" width="100" alt=""> </a> </td>
                                                    <td>
                                                        <a href="action/edit-user/edit.php?id=<?= $d['id_user'] ?>"><i class="ti-pencil"></i></a>
                                                        <a href="action/edit-user/delete.php?id=<?= $d['id_user'] ?>" onclick="return confirm('Yakin ingin menghapus?')"><i class="ti-trash"></i> </a>
                                                    </td>
                                                </tr>
                                            <?php
                                            endforeach;
