...
$query = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 1");

$queryAll = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan");
$query2 = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 0");
$query4 = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 2");
$query5 = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 3");
$query6 = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 4");

$rowAll = mysqli_num_rows($queryAll);
$row0 = mysqli_num_rows($query2);
$row1 = mysqli_num_rows($query);
$row2 = mysqli_num_rows($query4);
$row3 = mysqli_num_rows($query5);
...
<head>
    ...
    <title>Pelanggan - Bayar DP</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="pelanggan-1.php">Bayar DP <span class="badge badge-light"><?= $row1 ?></span></a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Pelanggan Yang Belum Bayar DP</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['tgl_keluar'] ?></td>
                                                    <td><?= $d['status'] ?></td>
                                                    <td><img src="../user/asset/bukti-transaksi/dp/<?= $d['bukti_dp'] ?>" alt=""></td>
                                                    <td>
