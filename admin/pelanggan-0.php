...
$query = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 0");
...
<head>
    ...
    <title>Pelanggan - Menunggu Konfirmasi</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="pelanggan-0.php">Menunggu Konfirmasi <span class="badge badge-light"><?= $row0 ?></span></a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Menunggu Konfirmasi Admin</h4>
