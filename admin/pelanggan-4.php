...
$query = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 4");
...
<head>
    ...
    <title>Pelanggan - Selesai Dikerjakan</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="pelanggan-4.php">Selesai Dikerjakan <span class="badge badge-light"><?= $row4 ?></span></a></li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Selesai Dikerjakan</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $d['tgl_keluar'] ?></td>
                                                    <td><?= $d['status'] ?></td>
                                                    <td><img src="../user/asset/bukti-transaksi/lunas/<?= $d['bukti_pelunasan'] ?>" alt=""></td>
                                                    <td>
