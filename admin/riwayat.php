...
$query = mysqli_query($conn, "SELECT * FROM keluhan_pelanggan WHERE status = 5");
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Riwayat Pelanggan</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Riwayat Pelanggan</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                ...
                <div class="mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Riwayat Pelanggan</h4>
